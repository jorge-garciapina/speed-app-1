...
export default function FormItem({
  ...
  function debouncedFunctionallity() {
    databaseSingleton.verifyAvailableName(currentEntryValue.current);
    // TODO: I need to repeat this process for email
    //       It is a simple validation to see if those names are valid
